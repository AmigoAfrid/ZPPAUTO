sap.ui.define(
    ...
    function(BaseController, IconPool, JSONModel) {
      ...
      return BaseController.extend("zautodesignapp.controller.qa01.report.qa01_report", {
            ...
            onValueHelpRequest: function () {
                ...
                if (Date || Date.length == 0) {
                    ...
                    function finishFetching() {
                        ...
                        that.loadFragment({
                            name: "zautodesignapp.view.qa01.report.fragment.ValueHelpDialogQA01"
      ...
      OnGoItemPage: async function (token) {
        ...
        // Data fetch header
        const model0 = this.getView().getModel("ZSB_AU_QA01_ITEM");
            ...
            onValueHelpRequest_: function () {
                ...
                if (Date || Date.length == 0) {
                    ...
                    function finishFetching() {
                        ...
                        that.loadFragment({
                            name: "zautodesignapp.view.qa01.report.fragment.ValueHelpDialogQA01Prod"
                        }).then(function (oDialog) {
                            var oFilterBar = oDialog.getFilterBar();
