sap.ui.define(
    [
        "zautodesignapp/controller/zlabel/transaction/zlabelbasecontroller",
    ...
    function (BaseController, IconPool, JSONModel) {
        ...
        return BaseController.extend("zautodesignapp.controller.zlabel.transaction.zlabel_selectrange", {
            onInit: function () {
                BaseController.prototype.onInit.call(this);
                var oMultiInput;
                oMultiInput = this.byId("idprocessorder1");
            ...
            onGoToScreen1: function () {
                ...
                this.TabZlabelItemModel.setProperty("/DatasZitem", []);
                // ✅ Refresh bindings if UI is still showing the old data
                this.TabZlabelItemModel.refresh(true);

                this.showScreen("screen1");
                this.byId("Box1_").setValue("");
            ...
            onValueHelpRequest: function () {
                ...
                function finishFetching() {
                    ...
                    that.loadFragment({
                        name: "zautodesignapp.view.zlabel.transaction.fragment.ValueHelpDialog"
            ...
            onValueHelpOkPress: function (oEvent) {
                ...
                if (aTokens && aTokens.length > 0) {
                    ...
                    this.byId("idprocessorder1").setValue(sSelectedValue);
            ...
            ondocumentsuggestselected: function (oEvent) {
                ...
                if (oSelectedItem) {
                    ...
                    var oMultiInput = this.getView().byId("idprocessorder1");
