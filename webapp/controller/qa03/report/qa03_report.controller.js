sap.ui.define(
    ...
    function(BaseController, IconPool, JSONModel) {
      ...
      return BaseController.extend("zautodesignapp.controller.qa03.report.qa03_report", {
        onInit: function () {
            ...
            onValueHelpRequest: function () {
                ...
                if (Date || Date.length == 0) {
                    ...
                    function finishFetching() {
                        ...
                        that.loadFragment({
                            name: "zautodesignapp.view.qa03.report.fragment.ValueHelpDialogQA03"
        ...
        OnDateChangeValueQA03: function (Datess) {
            var that = this;
            if (Datess !== null) {
        ...
        OnGoItemPage: async function (token) {
            ...
            // Data fetch header
            const model0 = this.getView().getModel("ZSB_AU_QA03_ITEM");
            ...
            onValueHelpRequest_: function () {
                ...
                if (Date || Date.length == 0) {
                    ...
                    function finishFetching() {
                        ...
                        that.loadFragment({
                            name: "zautodesignapp.view.qa03.report.fragment.ValueHelpDialogPTGProd"
                        }).then(function (oDialog) {
                            var oFilterBar = oDialog.getFilterBar();
