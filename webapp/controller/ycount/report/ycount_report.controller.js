sap.ui.define(
    ...
    function (BaseController, IconPool, MessageBox,
        ...
        return BaseController.extend("zautodesignapp.controller.ycount.report.ycount_report", {
            // Initialization hook
            onInit: function () {
            ...
            onValueHelpRequestPlant: function () {
                ...
                if (Date || Date.length == 0) {
                    ...
                    function finishFetching() {
                        ...
                        that.loadFragment({
                            name: "zautodesignapp.view.ycount.report.fragment.ValueHelpDialogPlant"
            ...
            // Fragment Batch
                ...
                if (Date || Date.length == 0) {
                    ...
                    function finishFetching() {
                        ...
                        that._oBasicSearchField = new sap.m.SearchField();
                        that.loadFragment({
                            name: "zautodesignapp.view.ycount.report.fragment.ValueHelpDialogACM"
                        }).then(function (oDialog) {
                            var oFilterBar = oDialog.getFilterBar();
            ...
            onValueHelpRequest_: function () {
                ...
                if (Date || Date.length == 0) {
                    ...
                    function finishFetching() {
                        ...
                        that.loadFragment({
                            name: "zautodesignapp.view.ycount.report.fragment.ValueHelpDialogZC"
                        }).then(function (oDialog) {
                            var oFilterBar = oDialog.getFilterBar();
